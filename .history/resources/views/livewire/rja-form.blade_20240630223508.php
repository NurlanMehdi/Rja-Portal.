                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-lg-6 mb-3" id="labour-section">
                                                    <div class="labour-item input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control labour-cost" value="0" wire:model="labourItems.0.cost">
                                                        <button type="button" class="remove-button me-2 btn btn-outline-danger" wire:click="removeLabourItem(0)">Remove</button>
                                                    </div>
                                                    ...
                                                    <div class="parts-item input-group mb-3">
                                                        ...
                                                        <div class="row w-100">
                                                            <div class="col-lg-2">
                                                                ...
                                                                <input type="text" class="form-control" value="" wire:model="partItems.0.number">
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <label class="form-label fs_14 fw_6">Part Cost:</label>
                                                                <input type="text" class="form-control parts-cost" value="0" wire:model="partItems.0.cost">
                                                            </div>
                                                        </div>
                                                        <button type="button" class="remove-button me-2 btn btn-outline-danger" wire:click="removePartItem(0)">Remove</button>
                                                    </div>
