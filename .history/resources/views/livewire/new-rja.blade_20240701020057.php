                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="col-lg-6 mb-3" id="labour-section">
                                        @foreach($labour_items as $index => $item)
                                            <div class="labour-item input-group mb-3">
                                                ...
                                                <input type="text" wire:model="labour_items.{{ $index }}.cost" class="form-control labour-cost" value="0" oninput="updateTotals()">
                                                <button type="button" class="remove-button me-2 remove-labour-item btn-outline-danger" wire:click="removeLabourItem({{ $index }})">&times;</button>
                                            </div>
                                        @endforeach
                                        <a href="#" class="fs_14 fw_6 text-primary add-link" id="add-labour-item" wire:click.prevent="addLabourItem">Add Additional Labour Item Line +</a>
                                    </div>
                                </div>
                                <div class="col-12 mt-4">
                                    <span class="fs_16 fw_6 mb-3 d-block bg-light p-2 rounded-1">
                                    ...
                                    <div class="col-lg-12" id="parts-section">
                                        @foreach($parts_items as $index => $item)
                                            <div class="parts-item input-group mb-3">
                                                ...
                                                <div class="row w-100">
                                                    <div class="col-lg-2">
                                                        ...
                                                        <input type="text" wire:model="parts_items.{{ $index }}.number" class="form-control">
                                                    </div>
                                                    <div class="col-lg-2">
                                                        <label class="form-label fs_14 fw_6">Part Cost:</label>
                                                        <input type="text" wire:model="parts_items.{{ $index }}.cost" class="form-control parts-cost" value="0" oninput="updateTotals()">
                                                    </div>
                                                    <button type="button" class="remove-button me-2 remove-parts-item btn-outline-danger" wire:click="removePartsItem({{ $index }})">&times;</button>
                                                </div>
                                            </div>
                                        @endforeach
                                        <a href="#" class="fs_14 fw_6 text-primary add-link" id="add-parts-item" wire:click.prevent="addPartsItem">Add Additional Part Item Line +</a>
                                    </div>
                                </div>
                            </div>
                        </div>
