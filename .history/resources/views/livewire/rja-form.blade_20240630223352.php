                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <select class="form-select" aria-label="Default select example" wire:model="companyProfile">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <input type="email" class="form-control" placeholder="Enter Maintenance Department Email" wire:model="maintenanceEmail">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <div class="d-flex align-items-center">
                                            <span class="fs_14 fw_6 me-2">B2B/Warranty Reference:</span>
                                            <input type="text" class="form-control" placeholder="Enter B2B/Warranty Reference" wire:model="warrantyReference">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 jd_column">
                                                <div class="align-items-center">
                                                    ...
                                                    <textarea class="form-control" rows="5" placeholder="write your comments....." wire:model="diagnosisFindings"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-lg-6 mb-3" id="labour-section">
                                                    @foreach($labour as $index => $labourItem)
                                                    <div class="labour-item input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control labour-cost" wire:model="labour.{{ $index }}.cost">
                                                        <button type="button" class="remove-button me-2 btn btn-outline-danger" wire:click="removeLabour({{ $index }})">Remove</button>
                                                    </div>
                                                    @endforeach
                                                    <a href="#" class="fs_14 fw_6 text-primary add-link" wire:click.prevent="addLabour">Add Additional Labour Item Line +</a>
                                                </div>
                                            </div>
                                            <div class="col-12 mt-4">
                                                <span class="fs_16 fw_6 mb-3 d-block bg-light p-2 rounded-1">PARTS:</span>
                                                <div class="col-lg-12" id="parts-section">
                                                    @foreach($parts as $index => $partItem)
                                                    <div class="parts-item input-group mb-3">
                                                        ...
                                                        <div class="row w-100">
                                                            <div class="col-lg-2">
                                                                ...
                                                                <input type="text" class="form-control" wire:model="parts.{{ $index }}.number">
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <label class="form-label fs_14 fw_6">Part Cost:</label>
                                                                <input type="text" class="form-control parts-cost" wire:model="parts.{{ $index }}.cost">
                                                            </div>
                                                        </div>
                                                        <button type="button" class="remove-button me-2 btn btn-outline-danger" wire:click="removePart({{ $index }})">Remove</button>
                                                    </div>
                                                    @endforeach
                                                    <a href="#" class="fs_14 fw_6 text-primary add-link" wire:click.prevent="addPart">Add Additional Part Item Line +</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 border-end">
                                        <div class="summary-section">
                                            ...
                                            <div class="center-button">
                                                <button class="btn btn-success mt-3" wire:click="submit">Send RJA to Maintenance Dept</button>
                                            </div>
