                                    ...
                                    <div class="col-12">
                                       ...
                                       <div class="col-lg-6 mb-3" id="labour-section">
                                          <div class="labour-item input-group mb-3">
                                             ...
                                             <input type="text" class="form-control labour-cost" value="0">
                                             <button type="button" class="remove-button me-2 remove-labour-item btn-outline-danger"></button>
                                          </div>
                                          ...
                                          <div class="parts-item input-group mb-3">
                                             ...
                                             <div class="row w-100">
                                                ...
                                                <div class="col-lg-2">
                                                   ...
                                                   <input type="text" class="form-control parts-cost" value="0">
                                                </div>
                                             </div>
                                          </div>
