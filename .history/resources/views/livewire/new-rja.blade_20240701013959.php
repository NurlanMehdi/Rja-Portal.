                                ...
                                <div class="col-12">
                                    ...
                                    <div class="col-lg-6 mb-3" id="labour-section">
                                        <div class="labour-item input-group mb-3">
                                            <label class="form-label fs_14 fw_6 me-3">LABOUR:</label>
                                            <label class="form-label fs_14 fw_4">Labour Cost:</label>
                                            <input type="text" wire:model="labour_items.0.cost" class="form-control labour-cost" value="0">
                                        </div>
                                ...
                                <div class="col-12 mt-4">
                                    ...
                                    <div class="col-lg-12" id="parts-section">
                                        <div class="parts-item input-group mb-3">
                                            <label class="form-label fs_14 fw_6 me-2">Part:</label>
                                            <div class="row w-100">
                                                <div class="col-lg-2">
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <input type="text" wire:model="parts_items.0.cost" class="form-control parts-cost" value="0">
                                                </div>
                                            </div>
                                        </div>
                                        <a href="#" class="fs_14 fw_6 text-primary add-link" wire:click.prevent="addPartsItem">Add Additional Part Item Line +</a>
                                    </div>
                                </div>
                            </div>
                        </div>
