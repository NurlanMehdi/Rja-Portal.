...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-lg-block dropdown-toggle ps-2">K. Anderson</span>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#Scheduling-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-calendar2-check"></i>
          <span>Scheduling Panel</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="Scheduling-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../search-job.html">
              <i class="bi bi-circle"></i>
              <span>Job Search</span>
            </a>
          </li>
          <li>
            <a href="../new-job-inqueries.html">
              <i class="bi bi-circle"></i>
              <span>New Job Inquiries</span>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="../cancel-reschedule-inquiries.html">
              <i class="bi bi-circle"></i>
              <span>Cancel/Reschedule Inquiries</span>
            </a>
          </li>
          <li>
            <a href="../completed-and-claimed.html">
              <i class="bi bi-circle"></i>
              <span>Completed and Claimed Jobs</span>
            </a>
          </li>
          <li>
            <a href="../request-job-authorization.html">
              <i class="bi bi-circle"></i>
              <span>Request Job Authorization</span>
            </a>
          </li>
        </ul>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed active" data-bs-target="#Reporting-nav" data-bs-toggle="collapse" href="#">
        ...
        <ul id="Reporting-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="#" class="active">
              <i class="bi bi-circle"></i>
              <span>Job Report Search</span>
            </a>
          </li>
          <li>
            <a href="#">
              <i class="bi bi-circle"></i>
              <span>In Progress Reports</span>
            </a>
          </li>
          <li>
            <a href="#">
              <i class="bi bi-circle"></i>
              <span>Completed Reports-Awaiting an Audit</span>
            </a>
          </li>
          <li>
            <a href="#">
              <i class="bi bi-circle"></i>
              <span>Completed Reports-Passed an Audit</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#Claims-nav" data-bs-toggle="collapse" href="#">
          ...
          <span>Claims Panel</span>
          <i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="Claims-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="#">
              <i class="bi bi-circle"></i>
      ...
      </li><!-- End Claims Panel Nav -->

      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i>
          <span>Batches Panel</span>
          <i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Batch Search</span>
            </a>
          </li>
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Bah Pending</span>
            </a>
          </li>
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Batch Submitted</span>
            </a>
          </li>
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Batch Paid Awaiting Audit</span>
            </a>
          </li>
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Batch Paid Audit Approved</span>
            </a>
          </li>
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Batch in Need of Amendments</span>
            </a>
          </li>
        </ul>
      </li><!-- End Batches Nav -->
