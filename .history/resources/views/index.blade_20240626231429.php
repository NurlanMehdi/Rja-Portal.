                ...
                <div class="col-lg-12 border-end">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <a href="#" class="fs_14 fw_6 text-primary">Add Additional Labour Item Line +</a>
                        </div>
                        <div class="col-lg-12 mt-4">
                            ...
                            <a href="#" class="fs_14 fw_6 text-primary">Add Additional Part Item Line +</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function addLabourItem() {
            ...
            newLabourItem.className = 'labour-item d-flex mb-3';
            newLabourItem.innerHTML = `
                <button type="button" class="btn btn-danger btn-sm me-2 remove-labour-item">&times;</button>
                <div class="col-auto me-4">
                    <div class="d-flex align-items-center">
                        <span class="fs_14 fw_6 me-2">
                            LABOUR ${labourCount}:
                        ...
                        <input type="text" class="form-control ms-2" value="0.00">
                    </div>
                </div>
            `;
        ...
        function addPartsItem() {
            ...
            newPartsItem.className = 'parts-item d-flex mb-3';
            newPartsItem.innerHTML = `
                <button type="button" class="btn btn-danger btn-sm me-2 remove-parts-item">&times;</button>
                <div class="col-auto me-4">
                    <div class="d-flex align-items-center">
                        <span class="fs_14 fw_6 me-2">
                            Part ${partsCount}:
