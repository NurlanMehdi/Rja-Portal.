        ...
        newPartsItem.innerHTML = `
            ...
            <div class="row w-100">
                <div class="col-lg-2">
                    ...
                    <input type="text" wire:model="parts_items.${labourCount-1}.number" class="form-control" value="">
                </div>
                <div class="col-lg-2">
                    <label class="form-label fs_14 fw_6">Part Cost:</label>
                    <input type="text" wire:model="parts_items.${labourCount-1}.cost" class="form-control parts-cost" value="0" oninput="updateTotals()">
                </div>
                <div class="col-lg-2">
