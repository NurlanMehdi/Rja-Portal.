  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function addLabourItem() {
        ...
        newLabourItem.innerHTML = `
            ...
            <input type="text" wire:model="labour_items.${labourCount}.cost" class="form-control ms-2 labour-cost" value="0" oninput="updateTotals()">
        ...
        newPartsItem.innerHTML = `
            ...
            <div class="row w-100">
                ...
                <div class="col-lg-2">
                    ...
                    <input type="text" class="form-control parts-cost" value="0" oninput="updateTotals()">
                </div>
                <div class="col-lg-2">
