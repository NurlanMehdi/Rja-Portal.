  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function addLabourItem() {
        ...
        newLabourItem.innerHTML = `
            ...
            <input type="text" class="form-control ms-2 labour-cost" value="0" oninput="updateTotals()">
            <button type="button" class="remove-button me-2 remove-labour-item btn btn-outline-danger">&times;</button>
        `;
        ...
        newPartsItem.innerHTML = `
            ...
            <div class="row w-100">
                ...
                <div class="col-lg-2">
                    ...
                    <input type="text" class="form-control ms-2 parts-cost" value="0" oninput="updateTotals()">
                </div>
            </div>
            <button type="button" class="remove-button me-2 remove-parts-item btn btn-outline-danger">&times;</button>
        `;
