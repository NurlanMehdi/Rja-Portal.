...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed {{ request()->is('rja*') ? 'active' : '' }}" data-bs-target="#Reporting-nav" data-bs-toggle="collapse" href="#">
        ...
        <ul id="Reporting-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{ route('rja.list',['submitted']) }}" class="{{ Request::is('rja/list/submitted') ? 'active' : '' }}">
                <i class="bi bi-circle"></i>
                <span>Submitted RJA</span>
            </a>
          </li>
          <li>
              <a href="{{ route('rja.list',['approved']) }}" class="{{ Request::is('rja/list/approved') ? 'active' : '' }}">
                  <i class="bi bi-circle"></i>
                  <span>Approved RJA</span>
              </a>
          </li>
          <li>
              <a href="{{ route('rja.list',['denied']) }}"  class="{{ Request::is('rja/list/denied') ? 'active' : '' }}">
                  <i class="bi bi-circle"></i>
