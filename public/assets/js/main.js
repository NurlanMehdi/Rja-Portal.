    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        <div class="row w-100">
            ...
            <div class="col-lg-2">
                ...
                <span class="currencyinput"><span class="doller">$</span>
                <input type="text" wire:model="parts_items.${uniqueId}.cost" class="form-control parts-cost" placeholder="0.00" oninput="formatNumber(this)" onkeypress="return isNumberKey(event)">
                </span>
            </div>
